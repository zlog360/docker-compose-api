...
export const buildResponse = [
 ...
 export const UpConfig = {
  ...
  export const Config11 = [
      ...
      ' ---> 28a4c88cdbbf',
      'Step 2/8 : ENV PYTHONUNBUFFERED 1',
      ' ---> Using cache', ' ---> 63d653e9e17f',
      'Step 3/8 : RUN mkdir /code',
      ' ---> Using cache', ' ---> 386a8607acc0',
      'Step 4/8 : WORKDIR /code',
      ' ---> Using cache', ' ---> 98b8babbde1c',
      'Step 5/8 : COPY requirements.txt /code/',
      ' ---> Using cache', ' ---> 8bea96e6ec0c',
      'Step 6/8 : RUN pip install -r requirements.txt',
      ' ---> Using cache', ' ---> be1db0211edc',
      'Step 7/8 : COPY . /code/', ' ---> Using cache',
      ' ---> 8e39008f06af',
      'Step 8/8 : RUN python manage.py migrate',
      ' ---> Using cache', ' ---> cd9235bb6120',
      'Successfully built cd9235bb6120',
      'Successfully tagged docker_web:latest'
    ]
  ...
  export const CommanderExecKeys: string[] = [
    ...
    '_maxListeners', '_closesNeeded',
    '_closesGot',    'connected',
    'signalCode',    'exitCode',
    'killed',        'spawnfile',
    '_handle',       'spawnargs',
    'pid',           'stdin',
